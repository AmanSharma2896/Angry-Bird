...
background = pygame.image.load("background3.png").convert_alpha() # convert_alpha() is used to remove our background

# Loading our main character
redbird = pygame.image.load("red-bird3.png").convert_alpha() 

# Adding sling image
sling_image = pygame.image.load("sling-3.png").convert_alpha() 

# Adding all of our images and combination of character
full_sprite = pygame.image.load("full-sprite.png").convert_alpha() 
...
buttons = pygame.image.load("selected-buttons.png").convert_alpha()

pig_happy = pygame.image.load("pig_failed.png").convert_alpha()

stars = pygame.image.load("stars-edited.png").convert_alpha()
...
mouse_pressed = False
t1 = 0
tick_to_next_circle = 10    # Time between transition of one bird from another
...
sling_x , sling_y = 135 , 450    # Before streaching or pulling position of string
sling2_x , sling2_y = 160 , 450  # After streaching or pulling position of string
...
def vector(p0,p1):
    # return the vector out of this point
...
def load_music():
    #Load the music
    song1 = 'angry-birds.ogg'
    pygame.mixer.music.load(song1)
    pygame.mixer.music.play(-1)

def sling_action():
    
    # To change the position of sling
    ...
    pu = (uv1 * rope_length + sling_x , uv2 * rope_length + sling_y)    # here pu is displacement
    ...
    if mouse_distance > rope_length:
        ...
        mouse_distance += 10
        pu3 = (uv1*mouse_distance + sling_x , uv2*mouse_distance + sling_y)       # After we press mouse
    ...
    angle = math.atan((float(dy))/dx)                                            # atan = Inverse of tan
